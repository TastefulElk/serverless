      ...
      'initialize': () => {
        ...
        if (hasFunctionsWithEventBridgeTrigger) {
          if (useCloudFormation === false) {
            ...
            this.serverless._logDeprecation(
              'AWS_EVENT_BRIDGE_CUSTOM_RESOURCE_LEGACY_OPT_IN',
              'Provisioning AWS EventBridge resources with native CloudFormation is now enabled by default. You can remove "eventBridge.useCloudFormation" setting from your configuration to hide this message.'
            );
          }
        }
      },
